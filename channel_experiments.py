...
# see the results
cv2.namedWindow('Contour detection using blue channels only', 0)
...
cv2.drawContours(image=image_contour_green, contours=contours2, contourIdx=-1,
                 color=(0, 255, 0), thickness=2, lineType=cv2.LINE_AA)
# see the results
cv2.namedWindow('Contour detection using green channels only', 0)
...
cv2.drawContours(image=image_contour_red, contours=contours3, contourIdx=-1,
                 color=(0, 255, 0), thickness=2, lineType=cv2.LINE_AA)
# see the results
cv2.namedWindow('Contour detection using red channels only', 0)
