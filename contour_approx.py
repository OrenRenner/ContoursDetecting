...
# see the results
cv2.namedWindow('None approximation', 0)
...
cv2.drawContours(image_copy1, contours1, -1, (0, 255, 0), 2,
                 cv2.LINE_AA)
# see the results
cv2.namedWindow('Simple approximation', 0)
...
cv2.namedWindow('SIMPLE Approximation contours', 0)
...
# see the results
cv2.namedWindow('CHAIN_APPROX_SIMPLE Point only', 0)
